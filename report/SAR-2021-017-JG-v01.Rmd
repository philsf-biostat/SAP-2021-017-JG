...
```{r fig1, fig.cap="**Figura 1** Silhuetas médias de clusters hierárquicos para diferentes métricas."}
...
```{r fig2, fig.cap="**Figura 2** Silhuetas médias para diferentes métodos de ligação."}
# ![Age](../figures/distr_age.png)
...
```{r fig3, fig.cap="**Figura 3** Silhuetas médias para diferentes valores de k."}
# ![Age](../figures/distr_age.png)
...
```{r fig5, fig.cap="**Figura 5** Silhuetas do cluster hierárquico gerado com métrica “maximum”, o método de ligação “single” e k=2."}
...
```{r fig6, fig.cap="**Figura 6** Silhuetas do cluster hierárquico gerado com métrica de Minkowski com p=0.5, o método de ligação de Ward e k=10."}
