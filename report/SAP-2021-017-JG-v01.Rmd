...
Dados de deputados federais evangélicos, eleitos em 2018,
...
O agrupamento hierárquico pode ser usado para identificar os deputados evangélicos que pertencem a uma corporação pentecostal (classificação disponível no dataset, para conferência).
